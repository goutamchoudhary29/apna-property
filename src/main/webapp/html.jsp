...
<head>
  ...
  <title>Apna Property - Find your dream home</title>
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="contect.jsp" class="navbar-link" data-nav-link>Contact</a>
              </li>
               <li>
                <a href="login_register.jsp" class="navbar-link" data-nav-link>Login/Registration</a>
              </li>
               <li>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <button class="btn" onclick="window.location.href='enquiry.jsp'">
    Make An Enquiry
</button>
          </div>

          <figure class="hero-banner">
            <img src="firstp.jpg" alt="Modern house model" class="w-100">
          </figure>
           ...
           <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="goutamproperty.jsp">
                    <img src="h1.5 front.jpeg" alt="Best Home for family(2BHK)" class="w-100">
                  </a>
                  ...
                  <div class="banner-actions">
                    ...
                    <button class="banner-actions-btn">
                      ...
                      <address>52,Limbodi,Indore(M.P),India</address>
                    </button>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>Rs.20,000</strong>/Month
                  </div>

                  <h3 class="h3 card-title">
                    <a href="goutamproperty.jsp">Best Home for famliy(2Bhk)</a>
                  </h3>
                ...
                <div class="card-footer">
                  ...
                  <div class="card-author">
                    ...
                    <figure class="author-avatar">
                      <img src="goutam agent.jpg" alt="Goutam Choudhary" class="w-100">
                    </figure>

                    <div>
                      <p class="author-name">
                        <a href="goutamproperty.jsp">Goutam Choudhary</a>
                      </p>

                      <p class="author-title">Shree Ram Real Estate Agents</p>
                    </div>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="manishproperty.jsp">
                    <img src="apart1.jpeg" alt="Modern Apartments" class="w-100">
                  </a>
                 ...
                 <div class="card-badge orange">For Sales</div>
                  ...
                  <div class="banner-actions">
                    ...
                    <button class="banner-actions-btn">
                      ...
                      <address>VijayNagar,Indore,M.P,India</address>
                    </button>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>Rs.1.75Cr</strong>
                  </div>

                  <h3 class="h3 card-title">
                    <a href="manishproperty.jsp">Modern Apartments</a>
                  </h3>
                ...
                <div class="card-footer">
                  ...
                  <div class="card-author">
                    ...
                    <figure class="author-avatar">
                      <img src="manish agent.png" alt="Manish Gurjar" class="w-100">
                    </figure>

                    <div>
                      <p class="author-name">
                        <a href="manishproperty.jsp">Manish Gurjar </a>
                      </p>

                      <p class="author-title">Gurjar Real Estate Agents</p>
                    </div>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="bhanuproperty.jsp">
                    <img src="plot2.jpeg" alt="Plot" class="w-100">
                  </a>
                  ...
                  <div class="banner-actions">
                    ...
                    <button class="banner-actions-btn">
                      ...
                      <address>Bhopal,M.P,India</address>
                    </button>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>Rs.1.05cr</strong>
                  </div>

                  <h3 class="h3 card-title">
                    <a href="bhanuproperty.jsp">Best Plot</a>
                  </h3>

                  <p class="card-text">
                   
                    Finance: "Maximize returns, minimize risk."
                    Customized plot development
                ...
                <div class="card-footer">
                  ...
                  <div class="card-author">
                    ...
                    <figure class="author-avatar">
                      <img src="bhanu agent.png" alt="Bhanu P.S.Cs" class="w-100">
                    </figure>

                    <div>
                      <p class="author-name">
                        <a href="bhanuproperty.jsp">Bhanu P.S chandrawat</a>
                      </p>

                      <p class="author-title">Mahakal Property Brokers</p>
                    </div>
            ...
            <li>
              <div class="property-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="hariomproperty.jsp">
                    <img src="h2.1front.jpg" alt="Comfortable Apartment" class="w-100">
                  </a>
               ...
               <div class="card-badge orange">For Sales</div>
                  ...
                  <div class="banner-actions">
                    ...
                    <button class="banner-actions-btn">
                      ...
                      <address>New Rani Bhag ,indore,M.P</address>
                    </button>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price">
                    <strong>Rs.76lac.</strong>
                  </div>

                  <h3 class="h3 card-title">
                    <a href="hariomproperty.jsp">Comfortable Apartment</a>
                  </h3>
                ...
                <div class="card-footer">
                  ...
                  <div class="card-author">
                    ...
                    <figure class="author-avatar">
                      <img src="hariom agent.png" alt="Hariom Ambiya" class="w-100">
                    </figure>

                    <div>
                      <p class="author-name">
                        <a href="hariomproperty.jsp">Hariom Ambiya</a>
                      </p>

                      <p class="author-title">OM Real Estate Agent</p>
                    </div>
      ...
      <section class="features">
        <div class="container">
          ...
          <h2 class="h2 section-title">Building Feature</h2>
      ...
      <section class="cta">
        <div class="container">
          ...
          <div class="cta-card">
            ...
            <a href ="#property" class="btn cta-btn">Explore Properties</a>
