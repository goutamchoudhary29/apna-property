  ...
  <main>
    ...
    <section class="property-info">
      <div class="property-header">
        ...
        <h3>Best Home For Family (3BHK)</h3>
  ...
  <div class="property-image">
    <div class="slider">
      <figure>
        <div class="slide">
          <h1></h1>
          <img src="h1.5 front.jpeg" alt="Property Image 1">
        </div>
        <div class="slide">
          <h1></h1>
          <img src="h 1.1.jpg" alt="Property Image 2">
        </div>
        <div class="slide">
          <h1></h1>
          <img src="h1.3.jpg" alt="Property Image 3">
        </div>
        <div class="slide">
          <h1></h1>
          <img src="h1.4.jpg" alt="Property Image 4">
        </div>
      </figure>
    </div>
  </div>
      <div class="property-configuration">
        <ul>
          <li><strong>Configuration:</strong> 3 Bedrooms, 2 Bathrooms, 1 Balcony</li>
          <li><strong>Rent:</strong> Rs. 20,000/month</li>
          <li><strong>Area:</strong> 1200 sq.ft.</li>
