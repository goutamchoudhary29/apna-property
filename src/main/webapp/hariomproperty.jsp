  ...
  <main>
    ...
    <section class="property-info">
      <div class="property-header">
        <h2>Om Real Estate Agent</h2>
        <h3>Comfortable Apartment</h3>
        <h2>Rs.76lac/-(76,00,000)/-</h2>
        <h3>3 Bedrooms, 2 Baths</h3>
        <p>Independent House/Villa for sales in New Rani Bhag, Indore, M.P</p>
      </div>
  ...
  <div class="property-image">
    <div class="slider">
      <figure>
        <div class="slide">
          <h1></h1>
          <img src="apart2.2.avif" alt="Property Image 1">
        </div>
        <div class="slide">
          <h1></h1>
          <img src="aprt2.1.avif" alt="Property Image 2">
        </div>
        <div class="slide">
          <h1></h1>
          <img src="apart2.4.avif" alt="Property Image 3">
        </div>
        <div class="slide">
          <h1></h1>
          <img src="apart2.3.avif" alt="Property Image 4">
        </div>
      </figure>
    </div>
  </div>
      <div class="property-configuration">
        <ul>
          <li><strong>Configuration:</strong> 3 Bedrooms, 2 Bathrooms</li>
          <li><strong>Rent:</strong> Rs.76lac/-</li>
          <li><strong>Area:</strong> 1500sq.ft.</li>
          <li><strong>Address:</strong> New Rani Bhag, Indore (M.P)</li>
          ...
          <li><strong>Posted By:</strong> Dealer Hariom Ambiya</li>
        </ul>
      </div>
    </section>
    ...
    <section class="additional-info">
      <table>
        ...
        <tr>
          <td>Property Age: 1 to 5 Years Old</td>
    ...
    <section class="about-property">
      ...
      <p>Address: New Rani Bhag, Indore, M.P</p>
      <p>This duplex Apartment for rent includes all furniture shown in photos.</p>
    </section>
  </main>
